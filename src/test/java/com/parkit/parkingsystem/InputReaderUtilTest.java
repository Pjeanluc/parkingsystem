...
class InputReaderUtilTest {
    ...
    public void readVehicleRegistrationNumberExceptionTest() {
        ...
        assertThrows(NoSuchElementException.class, () -> {
            inputSelection.readVehicleRegistrationNumber();
        });
    }
    ...
    void caculateDiffInHoursMoreOneHours() {
        ...
        // ACT
        double duration = InputReaderUtil.calculateDiffInHours((outTime.getTime() - (90 * 60 * 1000)),
                outTime.getTime());
    ...
    void caculateDiffInHoursLessOneHours() {
        ...
        // ACT
        double duration = InputReaderUtil.calculateDiffInHours((outTime.getTime() - (45 * 60 * 1000)),
                outTime.getTime());
    ...
    void caculateDiffInHoursMoreOneDay() {
        ...
        // ACT
        double duration = InputReaderUtil.calculateDiffInHours((outTime.getTime() - (25 * 60 * 60 * 1000)),
                outTime.getTime());
